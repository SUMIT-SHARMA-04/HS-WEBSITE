...
DEFAULT_MENU = [
    # --- FAST FOOD - BURGERS ---
    {"name": "Aloo tikki burger", "category": "Fast Food", "price": 60.00, "img": "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&q=80&w=600"},
    {"name": "Cheese burger", "category": "Fast Food", "price": 100.00, "img": "https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&q=80&w=600"},
    {"name": "Paneer burger", "category": "Fast Food", "price": 100.00, "img": "https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&q=80&w=600"},

    # --- FAST FOOD - SANDWICH ---
    {"name": "Veg grill", "category": "Sandwich", "price": 80.00, "img": "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&q=80&w=600"},
    {"name": "Cheese sandwich", "category": "Sandwich", "price": 120.00, "img": "https://images.unsplash.com/photo-1528736235302-52922df5c122?auto=format&fit=crop&q=80&w=600"},
    {"name": "Tanduri sandwich", "category": "Sandwich", "price": 100.00, "img": "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&q=80&w=600"},
    {"name": "Pizza sandwich", "category": "Sandwich", "price": 150.00, "img": "https://images.unsplash.com/photo-1528736235302-52922df5c122?auto=format&fit=crop&q=80&w=600"},

    # --- FAST FOOD - PIZZA ---
    {"name": "Margherita pizza", "category": "Pizza", "price": 140.00, "img": "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&q=80&w=600"},
    {"name": "Onion capsicum", "category": "Pizza", "price": 180.00, "img": "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=600"},
    {"name": "Cheese pizza", "category": "Pizza", "price": 220.00, "img": "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&q=80&w=600"},
    {"name": "Paneer pizza", "category": "Pizza", "price": 220.00, "img": "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=600"},
    {"name": "Farm house pizza", "category": "Pizza", "price": 280.00, "img": "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=600"},
    {"name": "Sweet corn pizza", "category": "Pizza", "price": 240.00, "img": "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&q=80&w=600"},

    # --- SOUTH INDIAN - IDLI ---
    {"name": "Idli (4-piece)", "category": "South Indian", "price": 100.00, "img": "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&q=80&w=600"},
    {"name": "Masala idli", "category": "South Indian", "price": 130.00, "img": "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&q=80&w=600"},

    # --- SOUTH INDIAN - DOSA ---
    {"name": "Plain dosa", "category": "South Indian", "price": 80.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Masala dosa", "category": "South Indian", "price": 120.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Chocolate dosa", "category": "South Indian", "price": 170.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Paneer dosa", "category": "South Indian", "price": 160.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Cheese dosa", "category": "South Indian", "price": 180.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Upma dosa", "category": "South Indian", "price": 200.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},
    {"name": "Butter Masala dosa", "category": "South Indian", "price": 170.00, "img": "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&q=80&w=600"},

    # --- SOUTH INDIAN SNACK ---
    {"name": "Mysore bonda (4-piece)", "category": "South Indian", "price": 100.00, "img": "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=600"},
    {"name": "Medu vada", "category": "South Indian", "price": 80.00, "img": "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=600"},
    {"name": "Upma", "category": "South Indian", "price": 80.00, "img": "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Aloo palak", "category": "Sabji", "price": 140.00, "img": "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Kadi pakoda", "category": "Sabji", "price": 140.00, "img": "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&q=80&w=600"},
    {"name": "Mix veg", "category": "Sabji", "price": 180.00, "img": "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Kadhai paneer", "category": "Sabji", "price": 200.00, "img": "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Kaju curry", "category": "Sabji", "price": 250.00, "img": "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Paneer tikka", "category": "Sabji", "price": 220.00, "img": "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Green mix veg", "category": "Sabji", "price": 160.00, "img": "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&q=80&w=600"},
    ...
    # --- BEVERAGES ---
    {"name": "Plain tea", "category": "Beverages", "price": 30.00, "img": "https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&q=80&w=600"},
    {"name": "Coffee", "category": "Beverages", "price": 50.00, "img": "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Milk", "category": "Beverages", "price": 50.00, "img": "https://images.unsplash.com/photo-1550514205-59b400494dfa?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Tava plain", "category": "Breads & Rice", "price": 10.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Tava butter", "category": "Breads & Rice", "price": 12.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Tava ghee", "category": "Breads & Rice", "price": 15.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Plain paratha", "category": "Breads & Rice", "price": 25.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Plain paratha butter", "category": "Breads & Rice", "price": 25.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Plain paratha ghee", "category": "Breads & Rice", "price": 40.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Onion paratha", "category": "Breads & Rice", "price": 60.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Aloo paratha", "category": "Breads & Rice", "price": 60.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Aloo pyaaz paratha", "category": "Breads & Rice", "price": 60.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Paneer paratha", "category": "Breads & Rice", "price": 80.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Missi roti", "category": "Breads & Rice", "price": 40.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Bajra roti", "category": "Breads & Rice", "price": 40.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},
    {"name": "Extra butter", "category": "Breads & Rice", "price": 30.00, "img": "https://images.unsplash.com/photo-1565557618474-0f2c4cb79133?auto=format&fit=crop&q=80&w=600"},

    # --- BREADS, RICE & SIDES - PULAV ---
    {"name": "Matar pulav", "category": "Breads & Rice", "price": 150.00, "img": "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=600"},
    {"name": "Paneer pulav", "category": "Breads & Rice", "price": 160.00, "img": "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=600"},
    {"name": "Vegetable pulav", "category": "Breads & Rice", "price": 160.00, "img": "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=600"},
    ...
    {"name": "Veg raita", "category": "Raita", "price": 70.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
    {"name": "Boondi raita", "category": "Raita", "price": 70.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
    {"name": "Butter chaach", "category": "Raita", "price": 20.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
    {"name": "Curd", "category": "Raita", "price": 25.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
    {"name": "Sweet lassi", "category": "Raita", "price": 50.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
    {"name": "Plain raita", "category": "Raita", "price": 50.00, "img": "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=600"},
